export const stageContent = {
  version: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Pause.\nReflect.\nChoose wisely.", supporting: "Align with what you feel and what you reason with.", active: true, order: 1 },
  participant: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Begin with\nwhere you are.", supporting: "Your context makes the reflection more useful.", active: true, order: 2 },
  personal: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Notice the\npattern.", supporting: "There are no right answers—only honest ones.", active: true, order: 3 },
  newjoiner: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Find your\nfooting.", supporting: "See how you balance belonging, judgement and instinct.", active: true, order: 4 },
  manager: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Lead with\nclarity.", supporting: "Understand what your team experiences from you.", active: true, order: 5 },
  executive: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Hold the\nwhole picture.", supporting: "Balance evidence, instinct and human consequence.", active: true, order: 6 },
  report: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "/media/stages/reflection-mobile.webp", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Turn insight\ninto action.", supporting: "Your result is a starting point, not a label.", active: true, order: 7 },
};
