export const stageContent = {
  ...
  participant: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Begin with\nwhere you are.", supporting: "Your context makes the reflection more useful.", active: true, order: 2 },
  personal: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Notice the\npattern.", supporting: "There are no right answers—only honest ones.", active: true, order: 3 },
  newjoiner: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Find your\nfooting.", supporting: "See how you balance belonging, judgement and instinct.", active: true, order: 4 },
  manager: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Lead with\nclarity.", supporting: "Understand what your team experiences from you.", active: true, order: 5 },
  executive: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Hold the\nwhole picture.", supporting: "Balance evidence, instinct and human consequence.", active: true, order: 6 },
  report: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional reflecting on how they think", focalPoint: "52% 50%", overlay: 0, headline: "Turn insight\ninto action.", supporting: "Your result is a starting point, not a label.", active: true, order: 7 },
};
