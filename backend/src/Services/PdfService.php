...
final class PdfService
{
    ...
    public function generate(int $reportId): string
    {
        ...
        $html = '<!doctype html><html><head><meta charset="utf-8"><style>'
            ...
            . '<div class="hero"><table class="hero-grid"><tr><td class="hero-score-cell"><div class="score">' . $overallScore . '<span>Out of 250</span></div><table class="hero-meter-labels"><tr><td>Head-led</td><td>' . $overallScore . '/250</td><td>Heart-led</td></tr></table><div class="hero-meter"><span style="width:' . $overallWidth . '%"></span></div></td><td class="hero-copy"><h2>Your alignment pattern</h2><p>' . $this->h((string) $summary) . '</p></td></tr></table></div>'
