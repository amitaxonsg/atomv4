...
final class PdfService
{
    ...
    public function generate(int $reportId): string
    {
        ...
        $html = '<!doctype html><html><head><meta charset="utf-8"><style>'
            ...
            . '.intro-grid,.edge-grid,.summary-grid,.score-grid,.feature-grid{width:100%;border-collapse:separate;border-spacing:1.8mm;table-layout:fixed}.intro-grid{margin:0 0 2.4mm}.intro-grid td{width:50%;vertical-align:top;padding:2.7mm;border:1px solid #E8DED2;border-radius:5px}.intro-strengths{border-top:3px solid #2F9E69!important;background:#F6FCF8}.intro-development{border-top:3px solid #B54B3D!important;background:#FFF7F5}.intro-grid h2{font-size:13.5pt}.intro-grid li{font-size:7.8pt}'
            . '.section-banner{page-break-inside:avoid;background:#27302F;color:#fff;padding:3.2mm 4mm;margin:2.4mm 0 1.6mm;border-radius:5px}.section-banner .block-eyebrow{color:#D6C6B5}.section-banner h2{color:#fff;margin:0;font-size:15.8pt}'
            . '.block-eyebrow{margin:0 0 .8mm;color:#8A8178;font-size:6.3pt;font-weight:bold;letter-spacing:.09em;text-transform:uppercase}.report-block{page-break-inside:avoid;border:1px solid #E8DED2;border-left:3px solid ' . $this->css($pdfAccent) . ';border-radius:5px;padding:3mm;margin:1.4mm 0;background:#FFFDF9}.report-block p{color:#4A4037}.accent-blue{border-left-color:#3D82D8}.accent-pink{border-left-color:#D8568C}.accent-teal{border-left-color:#36A89B}.accent-orange{border-left-color:#D99035}.accent-purple{border-left-color:#7964D8}.accent-green{border-left-color:#2F9E69}.accent-gold{border-left-color:#CAA34B}'
            . '.executive-block,.score-breakdown-block,.deep-dive-block,.roadmap-block,.profile-block,.reflection-block,.methodology-block,.upgrade-block{page-break-inside:auto}.executive-block{border-top:3px solid #CAA34B;background:#FFF9ED}.score-breakdown-block{border-top:3px solid #3D82D8}.edge-grid{margin:1.6mm 0}.edge-grid td{width:50%;vertical-align:top;border:1px solid #E8DED2;padding:2.8mm;background:#FFFDF9}.edge-grid td:first-child{border-top:3px solid #36A89B;background:#F7FCFB}.edge-grid td:last-child{border-top:3px solid #D99035;background:#FFFAF2}'
            . '.summary-grid{page-break-inside:auto}.summary-grid thead{display:table-header-group}.summary-grid tr{page-break-inside:avoid}.summary-grid th{width:50%;padding:2.4mm 2.8mm;text-align:left;font-family:' . $this->css($heading) . ';font-size:11.5pt;border:1px solid #E8DED2}.summary-grid th:first-child{border-top:3px solid #2F9E69;background:#F6FCF8}.summary-grid th:last-child{border-top:3px solid #B54B3D;background:#FFF7F5}.summary-grid td{width:50%;vertical-align:top;border:1px solid #E8DED2;padding:2.5mm 2.8mm;background:#fff}.summary-grid td:first-child{background:#F8FCF9}.summary-grid td:last-child{background:#FFF9F7}.summary-item{page-break-inside:avoid}.summary-item strong{font-size:8pt}.summary-item .scale{margin-bottom:0}'
            . '.subscale{page-break-inside:avoid;margin:1.5mm 0;padding:1.7mm 0;border-bottom:1px solid #EEE6DD}.subscale:last-child{border-bottom:0}.subscale-card{margin:1.2mm 0;padding:2.2mm;border:1px solid #E8DED2;border-left:3px solid #3D82D8;background:#fff;page-break-inside:avoid}.subscale-color-1{border-left-color:#3D82D8}.subscale-color-2{border-left-color:#D8568C}.subscale-color-3{border-left-color:#36A89B}.subscale-color-4{border-left-color:#D99035}.subscale-color-5{border-left-color:#7964D8}.comparison-row{border-bottom:1px solid #EEE6DD;padding:1.4mm 0}'
            . '.scale{height:3mm;background:#EEE7DE;border-radius:2mm;margin:.7mm 0 1.5mm}.scale span{display:block;height:100%;background:' . $this->css($head) . ';border-radius:2mm}.scale-labels{width:100%;font-size:5.5pt;color:' . $this->css($muted) . ';line-height:1.2}.scale-labels td{border:0!important;padding:0!important;width:33.33%!important}.scale-labels td:nth-child(2){text-align:center}.scale-labels td:last-child{text-align:right}'
            . '.score-intro{font-size:7.4pt;color:' . $this->css($muted) . ';margin:.6mm 0 1.8mm}.score-grid{border-spacing:1.5mm}.score-grid tr{page-break-inside:avoid}.score-grid>tbody>tr>td{width:50%;vertical-align:top;padding:0;border:0}.score-item{border:1px solid #E8DED2;border-left:3px solid #3D82D8;background:#fff;padding:2.2mm;page-break-inside:avoid}.score-color-1{border-left-color:#3D82D8}.score-color-1 .scale span{background:#3D82D8}.score-color-2{border-left-color:#D8568C}.score-color-2 .scale span{background:#D8568C}.score-color-3{border-left-color:#36A89B}.score-color-3 .scale span{background:#36A89B}.score-color-4{border-left-color:#D99035}.score-color-4 .scale span{background:#D99035}.score-color-5{border-left-color:#7964D8}.score-color-5 .scale span{background:#7964D8}.score-item-head{width:100%;border-collapse:collapse;margin-bottom:1mm}.score-item-head td{border:0;padding:0;vertical-align:middle}.score-area{font-size:7.6pt;font-weight:bold;line-height:1.2}.score-value{text-align:right;font-size:7.1pt;font-weight:bold;white-space:nowrap}.score-legend{font-size:7.1pt;color:' . $this->css($muted) . ';background:#FFF8EE;padding:2.2mm;border:1px solid #EADCC7}'
    ...
    private function executiveSummary(array $scores, string $trackKey): string
    {
        ...
        $highest = array_slice($items, 0, 3);
        $lowest = array_reverse(array_slice($items, -3));
        $rows = '';
        for ($i = 0; $i < 3; $i++) {
            $rows .= '<tr>'
                . '<td>' . $this->executiveSummaryItem($highest[$i] ?? null, $trackKey) . '</td>'
                . '<td>' . $this->executiveSummaryItem($lowest[$i] ?? null, $trackKey) . '</td>'
                . '</tr>';
        }
        return '<div class="report-block executive-block"><p class="block-eyebrow">At a glance</p><h2>Executive Summary</h2><p>Your highest and lowest assessment areas show where your current pattern is strongest and where focused development may have the greatest value.</p>'
            . '<table class="summary-grid"><thead><tr><th>Highest 3</th><th>Lowest 3</th></tr></thead><tbody>' . $rows . '</tbody></table></div>';
    }

    private function executiveSummaryItem(?array $item, string $trackKey): string
    {
        if (!$item) return '';
        $value = max(5, min(25, (int) ($item['score'] ?? 5)));
        $width = max(0, min(100, (int) round((($value - 5) / 20) * 100)));
        return '<div class="summary-item"><strong>' . $this->h($this->areaName($trackKey, (string) ($item['code'] ?? ''))) . ' · ' . $value . '/25</strong>'
            . '<table class="scale-labels"><tr><td>5 · Head-led</td><td>15 · Balanced</td><td>25 · Heart-led</td></tr></table>'
            . '<div class="scale"><span style="width:' . $width . '%"></span></div></div>';
    }
