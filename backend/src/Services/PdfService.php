...
final class PdfService
{
    ...
    public function generate(int $reportId): string
    {
        ...
        $html = '<!doctype html><html><head><meta charset="utf-8"><style>'
            . '@page{margin:10mm 10mm 12mm}body{font-family:' . $this->css($body) . ';color:' . $this->css($ink) . ';font-size:8.8pt;line-height:1.42;background:' . $this->css($canvas) . ';margin:0}'
            . 'h1,h2,h3,h4{font-family:' . $this->css($heading) . ';page-break-after:avoid;color:#2B241D}h1{font-size:26pt;line-height:1.03;margin:1mm 0 2mm;color:#B54B3D}h2{font-size:15.5pt;margin:0 0 2mm}h3{font-size:12.5pt;margin:0 0 1.6mm}h4{font-size:9.8pt;margin:0 0 1mm}p{margin:0 0 1.6mm}ul,ol{padding-left:4.7mm;margin:1.2mm 0 0}li{margin-bottom:.9mm}'
            . '.brand-row{width:100%;border-collapse:collapse;margin:0 0 2mm}.brand-row td{border:0;padding:0}.brand-cell{text-align:right;vertical-align:top}.logo{width:40mm;max-height:13mm;object-fit:contain}.brand{font-weight:bold;letter-spacing:.08em;color:' . $this->css($heart) . ';font-size:8.6pt;text-align:right}'
            . '.eyebrow{margin:0 0 1.2mm;color:#B54B3D;font-size:7pt;font-weight:bold;letter-spacing:.12em;text-transform:uppercase}.lead{margin:0 0 .8mm;color:#4A4037;font-size:8.3pt;line-height:1.4}.completion-meta{margin:0 0 2.5mm;color:' . $this->css($muted) . ';font-size:7pt}'
            . '.hero{page-break-inside:avoid;background:#252832;color:#fff;padding:4mm;margin:3.5mm 0 3mm;border:1px solid #CAA34B;border-radius:6px}.hero-grid{width:100%;border-collapse:separate;border-spacing:3mm 0;table-layout:fixed}.hero-grid td{vertical-align:middle}.hero-score-cell{width:28%;height:32mm;padding:4mm;border:1px solid #D9B66A;background:#2A2B36;text-align:center;vertical-align:middle!important}.hero-copy{width:72%;padding:.5mm 0 0 1mm;vertical-align:middle!important}.hero-copy h2{margin:0 0 1.6mm;color:#F2D78F;font-family:' . $this->css($body) . ';font-size:8.3pt;font-weight:bold;letter-spacing:.07em;text-transform:uppercase}.hero-copy p{margin:0;color:#fff;font-size:10pt;line-height:1.45}.score{font-family:' . $this->css($heading) . ';font-size:27pt;color:#fff;line-height:1;margin:0;text-align:center}.score span{display:block;margin-top:1.2mm;color:#F7EFE2;font-family:' . $this->css($body) . ';font-size:6.6pt;font-weight:bold;letter-spacing:.07em;text-align:center;text-transform:uppercase}.hero-meter-labels{width:100%;margin-top:3.6mm;border-collapse:collapse;color:#EEE7DC;font-size:5.7pt;font-weight:bold;line-height:1.2;text-transform:uppercase}.hero-meter-labels td{width:33.33%;padding:0;border:0}.hero-meter-labels td:first-child{text-align:left}.hero-meter-labels td:nth-child(2){text-align:center}.hero-meter-labels td:last-child{text-align:right}.hero-meter{height:3mm;margin-top:1mm;background:#62636B;border-radius:2mm;overflow:hidden}.hero-meter span{display:block;height:100%;min-width:1px;background:#D8568C;border-radius:2mm}'
            . '.intro-grid,.edge-grid,.summary-grid,.score-grid,.feature-grid{width:100%;border-collapse:separate;border-spacing:2mm;table-layout:fixed}.intro-grid{margin:0 0 3mm}.intro-grid td{width:50%;vertical-align:top;padding:3mm;border:1px solid #E8DED2;border-radius:5px}.intro-strengths{border-top:3px solid #2F9E69!important;background:#F6FCF8}.intro-development{border-top:3px solid #B54B3D!important;background:#FFF7F5}.intro-grid h2{font-size:14pt}.intro-grid li{font-size:8pt}'
            . '.section-banner{page-break-inside:avoid;background:#27302F;color:#fff;padding:4mm 4.5mm;margin:3.5mm 0 2.5mm;border-radius:5px}.section-banner .block-eyebrow{color:#D6C6B5}.section-banner h2{color:#fff;margin:0;font-size:16.5pt}'
            . '.block-eyebrow{margin:0 0 1mm;color:#8A8178;font-size:6.5pt;font-weight:bold;letter-spacing:.09em;text-transform:uppercase}.report-block{page-break-inside:avoid;border:1px solid #E8DED2;border-left:3px solid ' . $this->css($pdfAccent) . ';border-radius:5px;padding:3.5mm;margin:2mm 0;background:#FFFDF9}.report-block p{color:#4A4037}.accent-blue{border-left-color:#3D82D8}.accent-pink{border-left-color:#D8568C}.accent-teal{border-left-color:#36A89B}.accent-orange{border-left-color:#D99035}.accent-purple{border-left-color:#7964D8}.accent-green{border-left-color:#2F9E69}.accent-gold{border-left-color:#CAA34B}'
            . '.score-breakdown-block,.deep-dive-block,.roadmap-block,.profile-block,.reflection-block,.methodology-block{page-break-inside:auto}.executive-block{border-top:3px solid #CAA34B;background:#FFF9ED}.score-breakdown-block{border-top:3px solid #3D82D8}.edge-grid{margin:2mm 0}.edge-grid td{width:50%;vertical-align:top;border:1px solid #E8DED2;padding:3.2mm;background:#FFFDF9}.edge-grid td:first-child{border-top:3px solid #36A89B;background:#F7FCFB}.edge-grid td:last-child{border-top:3px solid #D99035;background:#FFFAF2}.summary-grid td{width:50%;vertical-align:top;border:1px solid #E8DED2;padding:3mm;background:#fff}.summary-grid td:first-child{border-top:3px solid #2F9E69;background:#F6FCF8}.summary-grid td:last-child{border-top:3px solid #B54B3D;background:#FFF7F5}'
            . '.subscale{page-break-inside:avoid;margin:1.8mm 0;padding:2mm 0;border-bottom:1px solid #EEE6DD}.subscale:last-child{border-bottom:0}.subscale-card{margin:1.5mm 0;padding:2.5mm;border:1px solid #E8DED2;border-left:3px solid #3D82D8;background:#fff;page-break-inside:avoid}.subscale-color-1{border-left-color:#3D82D8}.subscale-color-2{border-left-color:#D8568C}.subscale-color-3{border-left-color:#36A89B}.subscale-color-4{border-left-color:#D99035}.subscale-color-5{border-left-color:#7964D8}.comparison-row{border-bottom:1px solid #EEE6DD;padding:1.6mm 0}'
            . '.scale{height:3mm;background:#EEE7DE;border-radius:2mm;margin:.8mm 0 1.8mm}.scale span{display:block;height:100%;background:' . $this->css($head) . ';border-radius:2mm}.scale-labels{width:100%;font-size:5.7pt;color:' . $this->css($muted) . ';line-height:1.2}.scale-labels td{border:0!important;padding:0!important;width:33.33%!important}.scale-labels td:nth-child(2){text-align:center}.scale-labels td:last-child{text-align:right}'
            . '.score-intro{font-size:7.6pt;color:' . $this->css($muted) . ';margin:.8mm 0 2.2mm}.score-grid{border-spacing:1.8mm}.score-grid>tbody>tr>td{width:50%;vertical-align:top;padding:0;border:0}.score-item{border:1px solid #E8DED2;border-left:3px solid #3D82D8;background:#fff;padding:2.5mm;page-break-inside:avoid}.score-color-1{border-left-color:#3D82D8}.score-color-1 .scale span{background:#3D82D8}.score-color-2{border-left-color:#D8568C}.score-color-2 .scale span{background:#D8568C}.score-color-3{border-left-color:#36A89B}.score-color-3 .scale span{background:#36A89B}.score-color-4{border-left-color:#D99035}.score-color-4 .scale span{background:#D99035}.score-color-5{border-left-color:#7964D8}.score-color-5 .scale span{background:#7964D8}.score-item-head{width:100%;border-collapse:collapse;margin-bottom:1.2mm}.score-item-head td{border:0;padding:0;vertical-align:middle}.score-area{font-size:7.8pt;font-weight:bold;line-height:1.2}.score-value{text-align:right;font-size:7.3pt;font-weight:bold;white-space:nowrap}.score-legend{font-size:7.3pt;color:' . $this->css($muted) . ';background:#FFF8EE;padding:2.5mm;border:1px solid #EADCC7}'
            ...
            . ($completed !== '' ? '<p class="completion-meta">Completed ' . $this->h($completed) . '</p>' : '<div style="height:1mm"></div>')
            . '<div class="hero"><table class="hero-grid"><tr><td class="hero-score-cell"><div class="score">' . $overallScore . '<span>Out of 250</span></div></td><td class="hero-copy"><h2>Your alignment pattern</h2><p>' . $this->h((string) $summary) . '</p><table class="hero-meter-labels"><tr><td>Head-led</td><td>' . $overallScore . '/250</td><td>Heart-led</td></tr></table><div class="hero-meter"><span style="width:' . $overallWidth . '%;background-color:#D8568C"></span></div></td></tr></table></div>'
    ...
    private function subscaleReads(mixed $reads, string $trackKey): string
    {
        ...
        foreach ($reads as $code => $value) {
            ...
            $cards .= '<div class="subscale-card ' . $colourClass . '"><h4>' . $this->h($this->areaName($trackKey, (string) $code)) . '</h4><p>' . $this->h((string) $value) . '</p></div>';
            $index++;
        }
        if ($cards === '') return '';
        return '<div class="report-block accent-blue deep-dive-block"><h3>Your 10-area deep dive</h3>' . $cards . '</div>';
    }
